...
export function ChangeMobileScreen({
  ...
  const formattedDisplay = cleanDigits
    ? `+91 ${cleanDigits.slice(0, 5)}${cleanDigits.length > 5 ? ' ' + cleanDigits.slice(5) : ''}`
    : '+91 ';
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        >
          {/* ── Segmented Switcher (Password | Mobile number) ── */}
          <View style={styles.segmentContainer}>
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={styles.segmentTextInactive}>Password</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.segmentActive}
              activeOpacity={1}
            >
              <Text style={styles.segmentTextActive}>Mobile number</Text>
            </TouchableOpacity>
          </View>

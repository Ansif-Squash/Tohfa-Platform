    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>{t('farmer.counterOffer.title') || 'Counter-Offer'}</Text>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>
            {t('farmer.counterOffer.title') || 'Counter-Offer Review'}
          </Text>
          <View style={styles.headerSpacer} />
        </View>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          {conflictWarning ? (
            <View style={styles.conflictBanner} accessibilityRole="alert">
              ...
              <Text style={styles.conflictText}>
                {t('farmer.counterOffer.conflictError') ||
          ...
          >
            <View style={styles.timerHeaderRow}>
              ...
              >
                {t('farmer.counterOffer.timer.title') || '24-Hour Response Window (BR-10)'}
              </Text>
            </View>
            <Text
              style={[
            ...
            >
              {timeState.isExpired
                ? t('farmer.counterOffer.timer.expired') || 'Response window lapsed — offer expired'
                : `${t('farmer.counterOffer.timer.remaining') || 'Time Remaining:'} ${formatCountdown(timeState.remainingMs)}`}
            </Text>
          </Card>
          ...
          <Card style={styles.roundsCard}>
            <View style={styles.roundHeaderRow}>
              ...
              <Text style={styles.roundTitle}>
                {t('farmer.counterOffer.rounds.title') || 'Negotiation Rounds (BR-11)'}
              </Text>
            </View>
            ...
            {!eligibleToCounter ? (
              <View style={styles.roundLimitNotice}>
                ...
                <Text style={styles.roundLimitNoticeText}>
                  {t('farmer.counterOffer.rounds.limitReached') ||
          ...
          <View style={styles.comparisonContainer}>
            ...
            <Card style={styles.termCard}>
              <Text style={styles.termHeader}>
                {t('farmer.counterOffer.terms.original') || 'Your Original Price'}
              </Text>
            ...
            <Card style={[styles.termCard, styles.counterTermCard]}>
              <Text style={[styles.termHeader, styles.counterTermHeader]}>
                {t('farmer.counterOffer.terms.counter') || 'Admin Counter-Offer'}
              </Text>
          ...
          {offer.message ? (
            <Card style={styles.adminNoteCard}>
              <Text style={styles.adminNoteLabel}>
                {t('farmer.counterOffer.adminNote') || 'Admin Note'}:
              </Text>
          ...
          {mode === 'COUNTER_BACK' && eligibleToCounter && !timeState.isExpired ? (
            <Card style={styles.counterBackCard}>
              <Text style={styles.counterBackTitle}>
                {t('farmer.counterOffer.button.counterBack') || 'Counter Back'} (Round {offer.round + 1} of 3)
              </Text>
              <View style={styles.inputContainer}>
                <Input
                  label={t('farmer.counterOffer.input.price') || 'Your Counter Price (₹/kg)'}
                  value={counterPrice}
              ...
              <View style={styles.inputContainer}>
                <Input
                  label={t('farmer.counterOffer.input.qty') || 'Quantity (kg)'}
                  value={counterQty}
              ...
              <View style={styles.inputContainer}>
                <Input
                  label={t('farmer.counterOffer.input.message') || 'Message to Admin (optional)'}
                  value={farmerMessage}
              ...
              <View style={styles.actionRow}>
                <Button
                  title={t('farmer.counterOffer.button.submitCounter') || 'Submit Counter-Offer'}
                  variant="primary"
          ...
          {mode === 'REJECT_CONFIRM' && !timeState.isExpired ? (
            <Card style={styles.rejectCard}>
              <Text style={styles.rejectTitle}>
                {t('farmer.counterOffer.button.reject') || 'Reject Offer'}
              </Text>
          ...
          {mode === 'VIEW' ? (
            <View style={styles.actionStack}>
              <Button
                title={t('farmer.counterOffer.button.accept') || 'Accept Offer'}
                variant="primary"
              ...
              <View style={styles.secondaryActionRow}>
                {eligibleToCounter ? (
                  <Button
                    title={t('farmer.counterOffer.button.counterBack') || 'Counter Back'}
                    variant="outline"
                    disabled={timeState.isExpired || submitting}
                ...
                <Button
                  title={t('farmer.counterOffer.button.reject') || 'Reject Offer'}
                  variant="outline"
                  disabled={timeState.isExpired || submitting}

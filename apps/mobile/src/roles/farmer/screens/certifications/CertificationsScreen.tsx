    ...
    return (
      <Card style={styles.certItemCard}>
          ...
          <Badge
            label={
              item.verificationStatus === 'VERIFIED'
                ? t('farmer.certifications.status.VERIFIED')
                : item.verificationStatus === 'UNVERIFIED'
                  ? t('farmer.certifications.status.UNVERIFIED')
                  : t('farmer.certifications.status.REJECTED')
            }
            variant={
              item.verificationStatus === 'VERIFIED'
                ? 'success'
        ...
        <Text style={styles.issuerText}>
          {t('farmer.certifications.issuingBody')}: {item.issuingBody}
        </Text>

        <Text style={styles.validityText}>
          {t('farmer.certifications.validity', { from: item.issuedOn, to: item.expiresOn })}
        </Text>
          ...
          <View style={styles.blocksBanner}>
            ...
            <Text style={styles.blocksBannerText}>
              {warning.isExpired
                ...
                : t('farmer.dashboard.banner.certUnverified')}
            </Text>
          </View>
        ) : null}
      </Card>
      ...
      <SafeAreaView style={styles.screen}>
        <View style={styles.container}>
          <View style={styles.header}>
            <View>
              <Text style={styles.title}>{t('farmer.certifications.title')}</Text>
              <Text style={styles.subtitle}>{t('farmer.certifications.subtitle')}</Text>
            </View>
          </View>
    ...
    <SafeAreaView style={styles.screen}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Button
            title={t('farmer.certifications.add')}
            variant="primary"
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              title={t('farmer.certifications.empty') || 'No certificates found'}

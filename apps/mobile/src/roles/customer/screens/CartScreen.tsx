...
const styles = StyleSheet.create({
  ...
  header: { padding: 16, borderBottomWidth: 1, borderBottomColor: neutral('grey100'), flexDirection: 'row', justifyContent: 'space-between' },
  headerText: { fontSize: 24, fontWeight: 'bold' },
  timerText: { fontSize: 14, color: colors.secondary, alignSelf: 'center' },
  itemRow: { padding: 16, borderBottomWidth: 1, borderBottomColor: neutral('grey100'), flexDirection: 'row', justifyContent: 'space-between' },
  itemName: { fontSize: 16 },
  itemPrice: { fontSize: 16, fontWeight: 'bold' },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: neutral('grey100') },
  ...
  emptyText: { fontSize: 18, color: neutral('grey500') },
